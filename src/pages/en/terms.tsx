    ...
    return (
        ...
        >
          ...
          <Text mb={4}>
            ...
            services (the "Service"). By using the Service, you agree to be bound
        ...
        <Text mb={4}>
          By using the Service, you may be able to submit data or other
          content (collectively, "User Input"). You retain ownership of any
          intellectual property rights that you hold in the User Input. By
          providing User Input to the Service, you grant us a worldwide,
          perpetual, irrevocable, non-exclusive, transferable, royalty-free
          license to use, reproduce, modify, adapt, publish, translate, create
          derivative works from, distribute, and display the User Input in any
          media.
        </Text>
        <Heading as="h3" size="md" mb={4} fontWeight="bold" mt={marginTop}>
        ...
        <Text mb={4}>
          ...
          content, materials, or products included on the Service. You
          ...
          purpose. We do not warrant that the Service, its servers, or email
          sent from us are free of viruses or other harmful components. We will
        ...
        <Text mb={4}>
          ...
          out of your use of the Service, your violation of these Terms, or your
        ...
        <Text mb={4}>
          ...
          can be found at <Link href='/en/privacy'>dodgelol.gg/en/privacy</Link>. By using the Service, you consent to the collection,
          use, and sharing of your information as set out in our privacy policy.
        </Text>
        <Heading as="h3" size="md" mb={4} fontWeight="bold" mt={marginTop}>
          9. Contact Us
        </Heading>
