      ...
      <Main w="100vw" mt={0}>
        <Stack direction="column">
          ...
          <Stack width="100%" bgColor="#FAF3DD" p={'5vh'} height={"max-content"} pb={"10vh"}>
            ...
            <Center>
              <VStack>
            <Text color={'black'} fontFamily={"Bebas Neue"} fontSize={[16, 24]}>━━━━ OR ━━━━</Text>
            <Button leftIcon={<Image src="/riotlogo.png"/>} backgroundColor={"#FF4655"} _hover = {{bg: '#db3d4b'}} width={'max-content'} fontSize={["xs","xs", "md","l"]}> Sign In With Riot</Button>
            </VStack>
            </Center>
          </Stack>
          <Center>
